export const MATRIX_DATA = {
  ...
  "AIPPM (All India Political Parties Meet)": [
    ...
    { country: "Sonia Gandhi", status: "Open" },
    { country: "Rahul Gandhi", status: "Open" },
    { country: "Mallikarjun Kharge", status: "Open" },
    { country: "Priyanka Gandhi Vadra", status: "Open" },
    { country: "Shashi Tharoor", status: "Open" },
    ...
    { country: "Priyanka Chaturvedi", status: "Open" },
